...
GM_OFI_PARAM(FovPlanarView, clipPlanes, gmCore::float4, FovPlanarView::setClipPlanes);
GM_OFI_PARAM(FovPlanarView, clipAngles, gmCore::angle4, FovPlanarView::setClipAngles);
