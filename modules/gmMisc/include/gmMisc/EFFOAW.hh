...
typename EFFOAW::VEC EFFOAW::estimateVelocity
...
typename EFFOAW::VEC EFFOAW::estimatePosition(size_t id, double error_threshold, double time, size_t *ret_samples) const {
