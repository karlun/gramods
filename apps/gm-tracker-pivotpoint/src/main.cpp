...
int main(int argc, char *argv[]) {
  ...
  TCLAP::CmdLine cmd
    ("This is a tracker pivot point estimator for gramods. A configuration file or string must be specified and this must contain the definition of a tracker set (gmTrack::TrackerSet).");
